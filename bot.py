...
def clean_text(text: str) -> str:
    ...
    # หมายเหตุ: Regex นี้จะกรองเอาเฉพาะตัวอักษรไทยพื้นฐาน ก-๙ และอังกฤษ
